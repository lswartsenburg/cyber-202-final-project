...
def test_encrypt_decrypt():
    ...
    plaintext = "ABCD"
    expected_encrypted = "XYZQ"  # Expected result based on your encryption scheme
...
def test_unsupported_characters_encryption():
    ...
    plaintext = "WXYZ"  # Assuming WXYZ is not supported by your scheme
...
def test_unsupported_characters_decryption():
    ...
    encrypted_text = "WXYZ"  # Assuming WXYZ is not supported by your scheme
    with pytest.raises(UnsupportedCharacterError):
